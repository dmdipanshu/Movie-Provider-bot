...
STREAM_API = (environ.get('STREAM_API', 'cddea29a2faf08ed7060d92d50d420c013541f4d'))
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5617196215').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001909436537') #Channel / Group Id for force sub ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'cddea29a2faf08ed7060d92d50d420c013541f4d')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002016668528')) #Log channel id ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002024913058')).split()]
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002016668528'))
